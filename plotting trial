...
new_station_df = pd.DataFrame(
    {'coordinates': station_df['new_coordinates']})


# In[24]: Currently here, need to create POINTS to plot


s = gpd.GeoSeries(station_df['new_coordinates'])
